function doMod() {
	var colorScheme = {
		...
		'rgb(255,232,105)':		'rgb(255,222,44)',		// square / sentry in dominator mode
	...
	/*function loadTrDiv() {
		...
		setIntervalX(function() { window.google_ad_client = undefined; }, 50, 5);
	...
	['blur', 'focus'].forEach(function(e) {
		window.addEventListener(e, function() { holdingKey = {}; });
	});
	...
	function simulateKeyPress(key) {
		if(navigator.userAgent.toLowerCase().indexOf('firefox') != -1) {
			...
			window.dispatchEvent(new KeyboardEvent('keyup', { keyCode: key }));
		}
		else {
			var eventObj;
	...
	var tankInfo = {
		'list': {
			2: 'Twin', 4: 'Triplet', 6: 'Triple Shot', 8: 'Quad Tank', 10: 'Octo Tank', 12: 'Sniper', 14: 'Machine Gun', 16: 'Flank Guard',
			18: 'Tri-Angle', 20: 'Destroyer', 22: 'Overseer', 24: 'Overlord', 26: 'Twin Flank', 28: 'Penta Shot', 30: 'Assassin', 34: 'Necromancer',
			36: 'Triple Twin', 38: 'Hunter', 40: 'Gunner', 42: 'Stalker', 44: 'Ranger', 46: 'Booster', 48: 'Fighter', 50: 'Hybrid', 52: 'Manager', 54: 'X Hunter'
		},
		'order': {
			0:  [ 2, 12, 14, 16 ],      // 'Default': [ 'Twin', 'Sniper', 'Machine Gun', 'Flank Guard' ],
			2:  [ 6, 8, 26 ],           // 'Twin': [ 'Triple Shot', 'Quad Tank', 'Twin Flank' ],
			12: [ 30, 22, 38 ],         // 'Sniper': [ 'Assassin', 'Overseer', 'Hunter' ],
			14: [ 20, 40 ],             // 'Machine Gun': [ 'Destroyer', 'Gunner' ],
			16: [ 18, 8, 26 ],          // 'Flank Guard': [ 'Tri Angle', 'Quad Tank', 'Twin Flank' ],
			...
			22: [ 24, 34, 52 ],         // 'Overseer': [ 'Overlord', 'Necromancer', 'Manager' ],
			20: [ 50 ],                 // 'Destroyer' : [ 'Hybrid' ],
			18: [ 46, 48 ],             // 'Tri-Angle': [ 'Booster', 'Fighter' ],
			38: [ 56 ]                  // 'Hunter': [ 'X Hunter' ],
		},
		'order_min': { 0:[2,12,14,16],2:[6,8,26],12:[30,22,38],14:[20,40],16:[18,8,26],6:[4,28],8:[10],26:[10,36],30:[44,42],22:[24,34,52],20:[50],18:[46,48],38:[56] },
		'fullorder_min': { 0:{2:{6:[4,28],8:[10],26:[10,36]},12:{30:[44,42],22:[24,34,52],38:[56]},14:{20:[50],40:[]},16:{18:[46,48],8:[10],26:[10,36]}} }
	};
